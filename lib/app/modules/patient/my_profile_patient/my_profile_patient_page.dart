...
class MyProfilePatientPage extends StatefulWidget {
  const MyProfilePatientPage({super.key});

  @override
  State<MyProfilePatientPage> createState() => _MyProfilePatientPageState();
}

class _MyProfilePatientPageState extends State<MyProfilePatientPage> {
  final controller = DependencesInjector.get<MyProfilePatientController>();
  @override
